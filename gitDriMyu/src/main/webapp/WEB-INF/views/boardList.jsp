   ...
   function callBack(data){
      ...
      $.each(data, function(boardIdx, obj) {
         ...
         if("${loginMember.id}" == obj.id){
             bList += "<button class='btn btn-sm btn-success' onclick='goUpdate("+ obj.boardIdx +")'>수정</button>&nbsp;"
             bList += "<button class='btn btn-sm btn-primary' onclick='goDel("+ obj.boardIdx +")'>삭제</button>&nbsp;"
         }
         bList += "<button class='btn btn-sm btn-warning' onclick='closeView("+ obj.boardIdx +")'>닫기</button>"
         bList += "</td>";
         bList += "<tr>";
